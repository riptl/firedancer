...
#define FD_METRICS_COUNTER_NET_REGIME_SYSCALL_OFF  (39UL)
#define FD_METRICS_COUNTER_NET_REGIME_SYSCALL_NAME "net_regime_syscall"
#define FD_METRICS_COUNTER_NET_REGIME_SYSCALL_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_NET_REGIME_SYSCALL_DESC "Cumulative ticks spent waiting for syscalls"
#define FD_METRICS_COUNTER_NET_REGIME_SYSCALL_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_NET_TOTAL (24UL)
